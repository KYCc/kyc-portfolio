export const PlaywrightIcon = ({
                                   size = "1em",           // Fix 1: Scales correctly with your 'text-2xl' parent wrapper
                                   color = 'currentColor', // Fix 2: Inherits text color dynamically (matches react-icons)
                                   strokeWidth = 0,        // Fix 3: Removes the stroke so the solid shape isn't bloated
